...
**Carry-forward:** Redskap quiet / count×label from [`golvklart-redskap.sv.md`](../../docs/golvklart-redskap.sv.md). Marker chrome from [`station-tiles.sv.md`](../../docs/station-tiles.sv.md).  
...
Authority for this matrix also lives in [`golvklart-redskap.sv.md`](../../docs/golvklart-redskap.sv.md) (updated for Slice 17).

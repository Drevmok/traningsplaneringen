...
Living mirror: [`docs/copy-home-polish.sv.md`](../../docs/copy-home-polish.sv.md).  
Living companions: [`docs/distribution-copy.sv.md`](../../docs/distribution-copy.sv.md) · [`docs/ui-chrome.sv.md`](../../docs/ui-chrome.sv.md).
...
Honesty aside (`draftHonesty*`) stays as locked in [`distribution-copy.sv.md`](../../docs/distribution-copy.sv.md) — phone block does **not** replace it.
...
- Living companions: [`distribution-copy.sv.md`](../../docs/distribution-copy.sv.md) · [`ui-chrome.sv.md`](../../docs/ui-chrome.sv.md).

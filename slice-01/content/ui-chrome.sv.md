...
Full microcopy: `hall-declutter.sv.md` (under `docs/` and `slice-11/content/`) (also under `slice-11/content/`).
...
Full microcopy: `station-tiles.sv.md` (under `docs/` and `slice-12/content/`) (also under `slice-12/content/`).
...
Full microcopy: `station-compose.sv.md` (under `docs/` and `slice-13/content/`) (also under `slice-13/content/`).
...
## Golvklart redskap (Slice 14)

Full microcopy: `golvklart-redskap.sv.md` (under `docs/` and `slice-14/content/`) (also under `slice-14/content/`).

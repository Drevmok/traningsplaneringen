...
Pack source: [`slice-25/content/saknar-redskap-banner.sv.md`](../slice-25/content/saknar-redskap-banner.sv.md).  
Living companions: [`docs/hall-oversikt-copy.sv.md`](./hall-oversikt-copy.sv.md) · [`docs/hall-declutter.sv.md`](./hall-declutter.sv.md) · [`docs/ui-chrome.sv.md`](./ui-chrome.sv.md) · [`docs/anvand-alla-forslag.sv.md`](./anvand-alla-forslag.sv.md).
...
Full lock: [`anvand-alla-forslag.sv.md`](./anvand-alla-forslag.sv.md). Slice 25 only **points** at this control.

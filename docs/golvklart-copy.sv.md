...
**Slice 14:** Redskap lines under Teknik markörer in Golvklart/print — see [`golvklart-redskap.sv.md`](./golvklart-redskap.sv.md).
**Slice 17:** Short station titles on Golvklart **screen** — see [`golvklart-short-titles.sv.md`](./golvklart-short-titles.sv.md). This file stays Golvklart chrome only.

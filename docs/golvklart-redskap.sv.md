...
**Slice 17:** Short station titles on Golvklart **screen** (stack title then redskap). See [`golvklart-short-titles.sv.md`](./golvklart-short-titles.sv.md). Edit canvas stays title-hidden.
...
Slice 14 “short title print-only on Golvklart screen” is **superseded** for screen only — see [`golvklart-short-titles.sv.md`](./golvklart-short-titles.sv.md). Quiet redskap rules below stay intact.
...
- Short title: Golvklart **screen** + print (`hall-chip-title--print`); edit canvas stays hidden — Slice 17 ([`golvklart-short-titles.sv.md`](./golvklart-short-titles.sv.md))
...
- Förrådslista packing chrome (Slice 15 — see [`forradslista.sv.md`](./forradslista.sv.md); not under-markör copy)
...
- Companion: this file + [`golvklart-short-titles.sv.md`](./golvklart-short-titles.sv.md). Golvklart chrome stays in `golvklart-copy.sv.md`.

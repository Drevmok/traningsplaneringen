...
Living mirror: [`docs/forrad-empty-soft-path.sv.md`](./forrad-empty-soft-path.sv.md).  
Living companions: [`docs/forradslista.sv.md`](./forradslista.sv.md) · [`docs/anvand-alla-forslag.sv.md`](./anvand-alla-forslag.sv.md) · [`docs/ui-chrome.sv.md`](./ui-chrome.sv.md).
...
Full lock: [`anvand-alla-forslag.sv.md`](./anvand-alla-forslag.sv.md). Slice 24 only **points** at this control.

...
**Golvklart screen** + **print** show the short title under the markör (Slice 17 — [`golvklart-short-titles.sv.md`](../../docs/golvklart-short-titles.sv.md)); stack redskap below when present.

...
**Slice 11:** Hall tips / Kom igång steg 3 say **Teknik-stationer** — not all pass övningar. See also [`hall-declutter.sv.md`](../../slice-11/content/hall-declutter.sv.md).
**Slice 12:** Placed stations are **markörer** (icon-first); tap for details. See [`station-tiles.sv.md`](../../slice-12/content/station-tiles.sv.md).
**Slice 13:** Hall detail can list **redskap**; CTA **Redigera redskap**. See [`station-compose.sv.md`](../../docs/station-compose.sv.md).
**Slice 16:** Kom igång gets a soft fifth step — discover **Redigera redskap**. See [`kom-igang-redskap.sv.md`](../../docs/kom-igang-redskap.sv.md). Supersedes “no fifth step” below.
...
- **Slice 16:** Five soft steps (place → **Ange redskap** → Golvklart). Soft only — never block Golvklart. Auto-progress when any non-empty saved `stationEquipment`. Full lock: [`kom-igang-redskap.sv.md`](../../docs/kom-igang-redskap.sv.md).
...
- Checklist step order: Slice 16 A–F (5 steps; soft Golvklart). Wording here + [`kom-igang-redskap.sv.md`](../../docs/kom-igang-redskap.sv.md).

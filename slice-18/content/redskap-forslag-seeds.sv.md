...
**Status:** Docs lock — Slice 18 **APPROVED 2026-09-25**. Living table also in [`docs/station-compose.sv.md`](../../docs/station-compose.sv.md).  
...
**Carry-forward:** Library labels from [`station-compose.sv.md`](../../docs/station-compose.sv.md). Quiet rules from [`golvklart-redskap.sv.md`](../../docs/golvklart-redskap.sv.md) + [`forradslista.sv.md`](../../docs/forradslista.sv.md).  

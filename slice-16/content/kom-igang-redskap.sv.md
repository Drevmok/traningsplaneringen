...
**Authority merge:** Living Kom igång / tip keys also live in [`coach-tips.sv.md`](../../docs/coach-tips.sv.md). This file is the Slice 16 lock + companion.
...
- Broader förslag = Slice 18 ([`station-compose.sv.md`](../../docs/station-compose.sv.md) drill table)
- Golvklart short titles = Slice 17 ([`golvklart-short-titles.sv.md`](../../docs/golvklart-short-titles.sv.md))  
...
- Living keys also merged in [`coach-tips.sv.md`](../../docs/coach-tips.sv.md). Companion: [`kom-igang-redskap.sv.md`](../../docs/kom-igang-redskap.sv.md).
